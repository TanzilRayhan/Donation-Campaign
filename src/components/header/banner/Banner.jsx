const Banner = () => {
  return (
    <div>
      <div className="my-5 h-[60vh] py-20 flex flex-col justify-center items-center bg-white   " >
      <div className="container  text-3xl font-bold text-center ">
          <h1> I Grow By Helping People In Need</h1>
        </div>

        <div className="relative justify-center mt-8 items-center flex h-10 w-full min-w-[200px] max-w-[24rem]">
        <input
          type="email"
      ...
      {/* bg-[url('https://i.ibb.co/tPz3tK9/Rectangle-4281.png?fbclid=IwAR2RnpUw4f5LJNjwqb7So8gU1s6kFUiBgPoPi9UhXPR3fDvcaHhMNl0RJz4')] */}
